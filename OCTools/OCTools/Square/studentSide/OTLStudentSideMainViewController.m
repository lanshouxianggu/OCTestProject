//
//  OTLStudentSideMainViewController.m
//  OCTools
//
...
@interface OTLStudentSideMainViewController ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) NSArray *dataArray;

@end

@implementation OTLStudentSideMainViewController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    switch (indexPath.section) {
        case 0:
        {
            OTLStudentSidePracticePianoTaskVC *vc = [OTLStudentSidePracticePianoTaskVC new];
